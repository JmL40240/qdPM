...
function getBueditorButtons(path)
{
  return [
  ['H1','= %TEXT% =','h1.png',''],
  ['H2','== %TEXT% ==','h2.png',''],
  ['H3','=== %TEXT% ===','h3.png',''],
  ['tpl:','<img src="'+path+'/icons/separator.png" class="sep">','',''],
  
  [I18NText('Bold'),"'''%TEXT%'''",'b.png','B'],
  [I18NText('Italic'),"''%TEXT%''",'i.png','I'],
  ['tpl:','<img src="'+path+'/icons/separator.png" class="sep">','',''],
  [I18NText('Horizontal rule'),'----','hr.png',''],
  ['tpl:','<img src="'+path+'/icons/separator.png" class="sep">','',''],
  
  [I18NText('Bullet list'),'* %TEXT%','ul.png',''],
  [I18NText('Numbered list'),'# %TEXT%','ol.png',''],
  ['tpl:','<img src="'+path+'/icons/separator.png" class="sep">','',''],
  
  [I18NText('Internal link'),'[[%TEXT%]]', 'link.png', 'L'],
  [I18NText('External link (remember http:// prefix)'),'[http://%TEXT%]','link_nofollow.png',''],
  [I18NText('Picture'),'<img src="" alt="">', 'picture_up.png', 'L'],
  ['tpl:','<img src="'+path+'/icons/separator.png" class="sep">','',''],
  [I18NText('Table'),"{|\n!Orange\n!Apple\n|-\n|Bread\n|Pie\n|}", 'table.png', ''],
  ['tpl:','<img src="'+path+'/icons/separator.png" class="sep">','',''],
  [I18NText('Escape wiki markup'),'<nowiki>%TEXT%</nowiki>','class.png',''],
  ];
}
