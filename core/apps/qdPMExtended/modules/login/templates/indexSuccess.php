...
<div><?php if(strlen($c = strip_tags(sfConfig::get('app_login_page_content')))>0) echo '<div id="login-page-description"><p>' . sfConfig::get('app_login_page_content') . '</p></div>' ?></div>
