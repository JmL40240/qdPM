...
<div class="table-scrollable">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><?php echo renderBooleanValue($projects_types->getDefaultValue()) ?></td>
      <td><?php echo renderBackgroundColorBlock($projects_types->getBackgroundColor(),$projects_types->getBackgroundColor()) ?></td>
