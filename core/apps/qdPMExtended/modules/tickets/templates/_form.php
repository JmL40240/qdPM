...
<ul class="nav nav-tabs">
  ...
  <?php echo ExtraFieldsTabs::renderTabsHeaders('tickets',$sf_user) ?>      	
  <!--<li>
...
<div class="tab-content" >
  <div class="tab-pane fade active in" id="tab_general">         
      ...
      <div class="form-group">
        ...
        <?php include_component('patterns','patternsList',array('type'=>'tickets_description','field_id'=>'tickets_description'))?>
        </label>
      	<div class="col-md-9">
  ...
  <?php echo ExtraFieldsTabs::renderTabsContent('tickets',$form->getObject(), $sf_user) ?>
...
<?php echo input_hidden_tag('default_tickets_types_id',app::getDefaultValueByTable('TicketsTypes')) ?>
<?php if(!$form->getObject()->isNew()) echo input_hidden_tag('form_tickets_types_id',$form['tickets_types_id']->getValue()) ?>

<?php echo ExtraFields::getJsListPerGroup('TicketsTypes'); ?>
<?php echo TicketsTypes::getJsList(); ?>
<?php echo Departments::getTicketsTypesJsList() ?>


<script type="text/javascript">    
  $(function() {  
                         
    set_tickets_types_by_departmetn_id($('#tickets_departments_id').val());
