...
<div class="table-scrollable">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><?php echo __($discussions_status->getStatusGroup()) ?></td>
      <td><?php echo $discussions_status->getName() ?></td>
      <td><?php echo renderBooleanValue($discussions_status->getDefaultValue()) ?></td>
      <td><?php echo renderBackgroundColorBlock($discussions_status->getBackgroundColor(),$discussions_status->getBackgroundColor()) ?></td>            
