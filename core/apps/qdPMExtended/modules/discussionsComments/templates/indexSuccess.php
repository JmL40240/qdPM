...
<div class="panel panel-default item-description">
      ...
      <table>
        <tr>
          ...
          <td><span class="pageHeading"><?php echo ($discussions->getDiscussionsTypesId()>0 ? $discussions->getDiscussionsTypes()->getName(). ': ':'') . $discussions->getName() . ($discussions->getDiscussionsStatusId()>0 ? ' [' . $discussions->getDiscussionsStatus()->getName(). '] ':'') ?></span></td>    
...
<table>
  ...
  <?php endif ?>
    ...
    <div id="extraFieldsInDescription"><?php echo ExtraFieldsList::renderDescriptionFileds('discussions',$discussions,$sf_user,$discussions->getDiscussionsTypes()->getExtraFields()) ?></div>
