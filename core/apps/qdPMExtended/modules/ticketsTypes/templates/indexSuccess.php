...
<div class="table-scrollable">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><?php echo renderBooleanValue($tickets_types->getDefaultValue()) ?></td>      
      <td><?php echo renderBackgroundColorBlock($tickets_types->getBackgroundColor(),$tickets_types->getBackgroundColor()) ?></td>
