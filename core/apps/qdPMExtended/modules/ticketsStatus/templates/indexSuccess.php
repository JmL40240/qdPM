...
<div class="table-scrollable">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><?php echo __($tickets_status->getStatusGroup()) ?></td>
      <td><?php echo $tickets_status->getName() ?></td>
      <td><?php echo renderBooleanValue($tickets_status->getDefaultValue()) ?></td>      
      <td><?php echo renderBackgroundColorBlock($tickets_status->getBackgroundColor(),$tickets_status->getBackgroundColor()) ?></td>
