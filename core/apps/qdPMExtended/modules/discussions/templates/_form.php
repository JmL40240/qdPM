...
<ul class="nav nav-tabs">
  ...
  <?php echo ExtraFieldsTabs::renderTabsHeaders('discussions',$sf_user) ?>   
  <li>
...
<div class="tab-content" >
  <div class="tab-pane fade active in" id="tab_general">         
      ...
      <div class="form-group">
        ...
        <?php include_component('patterns','patternsList',array('type'=>'discussions_description','field_id'=>'discussions_description'))?>
        </label>
      	<div class="col-md-9">
  ...
  <?php echo ExtraFieldsTabs::renderTabsContent('discussions',$form->getObject(), $sf_user) ?>
...
<?php echo ExtraFields::getJsListPerGroup('DiscussionsTypes'); ?>

<script type="text/javascript">    
  $(function() {             
    set_extra_fields_per_group($('#discussions_discussions_types_id').val());                                                                    
  });
</script> 
