...
<form class="form-horizontal" method="post" action="<?php echo url_for('tasks/export') ?>">
...
<?php if($sf_request->hasParameter('projects_id')) echo input_hidden_tag('projects_id',$sf_request->getParameter('projects_id')) ?>
  ...
  <div class="form-group">
  	...
  	<div class="col-md-9">
  		<div id="extport_fields"><?php echo input_tag('filename',__('Tasks'),array('class'=>'form-control input-medium')) ?></div>
  	</div>
  </div>
