...
<form class="form-horizontal"  action="<?php echo url_for('tasks/multipleEdit') ?>" method="post">
...
<div class="tab-content" >
  ...
  <div  class="tab-pane fade" id="tab_assigned">
     <?php echo select_tag('fields[assigned_to]','',array('choices'=>Users::getChoices(array_merge(array($sf_user->getAttribute('id')),array_filter(explode(',',$projects->getTeam()))),'tasks',false,$projects->getId()),'expanded'=>true,'multiple'=>true))?>
  </div>
  <?php endif ?>
</div>
