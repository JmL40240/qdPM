...
?>
  ...
  <?php echo app::renderSubRelatedItems($tasks['id'],'TicketsToTasks',$sf_request->getParameter('tickets_id')) ?>
  <?php echo app::renderSubRelatedItems($tasks['id'],'DiscussionsToTasks') ?>
...
<?php
  ...
  {
    $button_add_html = link_to_modalbox('+ ' . __('Add'),'tasks/new?related_tickets_id=' . $sf_request->getParameter('tickets_id') . '&projects_id=' . $sf_request->getParameter('projects_id')) . ' | ' . link_to_modalbox(__('Link'),'tasks/bindTasks?related_tickets_id=' . $sf_request->getParameter('tickets_id') . '&projects_id=' . $sf_request->getParameter('projects_id'));
  }
...
<?php echo app::renderRelatedItemsWarning(array('status'=>$status,'type'=>'tasks','tickets_id'=>$sf_request->getParameter('tickets_id')))?>
