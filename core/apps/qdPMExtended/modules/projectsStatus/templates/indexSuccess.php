...
<div class="table-scrollable">
  ...
  <tbody>
    ...
    <tr>      
      ...
      <td><?php echo __($projects_status->getStatusGroup()) ?></td>
      <td><?php echo $projects_status->getName() ?></td>          
      <td><?php echo renderBooleanValue($projects_status->getDefaultValue()) ?></td>      
      <td><?php echo renderBackgroundColorBlock($projects_status->getBackgroundColor(),$projects_status->getBackgroundColor()) ?></td>
