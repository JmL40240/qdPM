...
<table>
  <tr>
    <td><?php echo __('Form Tab') ?></td>
    <td><?php echo select_tag('tab','',array('choices'=>ExtraFieldsTabs::getChoices($sf_request->getParameter('bind_type')))) ?></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td><?php echo select_tag('is_requried','',array('choices'=>array(''=>'','1'=>__('Yes'),'0'=>__('No')))) ?></td>
  </tr>
  <tr>
