        ...
        <table>
          <tr>
            ...
            <?php 
             ...
             {
               $m = app::getFilterExtraFields(array(),$table,'projects','projects/index',false,$filter_by[$table],$sf_user);
             }
             else
             {
                switch($table)
                {
                  case 'ProjectsStatus':  $m =  app::getFilterMenuStatusItemsByTable(array(),$table,'Status','projects/index',false,$filter_by[$table]);
                    break;
