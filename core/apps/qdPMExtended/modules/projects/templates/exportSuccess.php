...
<form class="form-horizontal" role="form"  method="post" action="<?php echo url_for('projects/export') ?>">
<div class="modal-body">
  <div class="form-body">
      ...
      <div class="form-group">
      	...
      	<div class="col-md-9">
      		<div id="extport_fields"><?php echo select_tag('fields',array('name','ProjectsStatus'),array('choices'=>$columns,'expanded'=>true,'multiple'=>true)) ?></div>
      	</div>
      </div>
      ...
      <div class="form-group">
      	...
      	<div class="col-md-9">
      		<div id="extport_fields"><?php echo input_tag('filename',__('Projects'),array('class'=>'form-control input-medium')) ?></div>
      	</div>
      </div>
