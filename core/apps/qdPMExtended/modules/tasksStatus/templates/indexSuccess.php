...
<div class="table-scrollable">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><?php echo __($tasks_status->getStatusGroup()) ?></td>      
      <td><?php echo $tasks_status->getName() ?></td>      
      <td><?php echo renderBooleanValue($tasks_status->getDefaultValue()) ?></td>
      <td><?php echo renderBackgroundColorBlock($tasks_status->getBackgroundColor(),$tasks_status->getBackgroundColor()) ?></td>
