...
<div class="form-group">
	<label class="col-md-3 control-label" for="cfg_app_use_skins"><?php echo __('Use Tasks Time Tracker'); ?></label>
  <div class="col-md-9">	
	  <?php echo select_tag('cfg[app_use_tasks_timetracker]',sfConfig::get('app_use_tasks_timetracker'),array('choices'=>$default_selector),array('class'=>'form-control input-small')); ?> 
  </div>			
</div>

<div class="form-group">
	<label class="col-md-3 control-label" for="cfg_app_use_skins"><?php echo __('Use Parent/Child Tasks'); ?></label>
  <div class="col-md-9">	
	  <?php echo select_tag('cfg[app_use_related_tasks]',sfConfig::get('app_use_related_tasks'),array('choices'=>$default_selector),array('class'=>'form-control input-small')); ?> 
  </div>			
</div>
