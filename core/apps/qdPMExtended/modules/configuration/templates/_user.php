...
<div class="form-group">
  ...
  <div class="col-md-9">	
	  <?php echo input_tag('cfg[app_new_user_email_subject]', sfConfig::get('app_new_user_email_subject'),array('class'=>'form-control input-xlarge')); ?>
...
<div class="form-group">
  ...
  <div class="col-md-9">	
	  <?php echo textarea_tag('cfg[app_new_user_email_body]', sfConfig::get('app_new_user_email_body'),array('class'=>'form-control editor')); ?>
    <span class="help-block">
      <?php echo  '<b>' . __('Note') . ':</b> ' . __('by default login details will be added at the end message')?><br>
