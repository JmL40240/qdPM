...
<!-- BEGIN HEAD -->
  <head>
    ...
    <?php echo stylesheet_tag('/template/plugins/bootstrap-modal/css/bootstrap-modal.css?v=1') ?>    
    ...
    <?php echo stylesheet_tag('/template/plugins/bootstrap-colorpicker/css/colorpicker.css') ?>
    ...
    <?php echo stylesheet_tag('/template/plugins/DataTables-1.10.15/media/css/dataTables.bootstrap.min.css') ?>
    <?php echo javascript_include_tag('/template/plugins/DataTables-1.10.15/media/js/jquery.dataTables.min.js') ?>
    <?php echo javascript_include_tag('/template/plugins/DataTables-1.10.15/media/js/dataTables.bootstrap.js') ?>
    ...
    <?php echo javascript_include_tag('/template/plugins/ckeditor/ckeditor.js?v=4.7.2') ?>    
    <?php echo javascript_include_tag('app.js?v=3') ?>
    ...
    <?php echo javascript_include_tag('helpers/wiki.js') ?>
    <?php echo javascript_include_tag('jquery.timers.js') ?>
    
    
    <?php echo stylesheet_tag('/js/chosen_v1.8.2/chosen.min.css') ?>
    
    <?php echo stylesheet_tag('/template/plugins/ckeditor/plugins/codesnippet/lib/highlight/styles/default.css') ?>
    ...
    <?php echo stylesheet_tag('app.css?v=4.2') ?>
    <?php
  ...
  <body class="page-header-fixed yui-skin-sam page-scale-reduced <?php echo ($sf_request->getCookie('sidebar_closed','0')==1 ? 'page-sidebar-closed':''); ?>" id="yahoo-com">
...
<?php echo javascript_include_tag('/template/plugins/bootstrap-colorpicker/js/bootstrap-colorpicker.js') ?>

<?php echo javascript_include_tag('/template/plugins/ckeditor/plugins/codesnippet/lib/highlight/highlight.pack.js') ?>

<?php echo javascript_include_tag('/js/chosen_v1.8.2/chosen.jquery.min.js') ?>

<?php echo javascript_include_tag('/template/scripts/app.js?v=3') ?>
