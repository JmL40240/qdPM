...
?> 
		...
		<li class>
			...
			<ul class="sub-menu" style="display: none;">
				...
				<li>
					<a class="outilDSI"  target="_blank" href="http://localhost/extensions/qdpm/projetstaches.php" ><span class="title">Liste des Tâches</span></a>
				</li>
				<li>
					<a class="outilDSI"  target="_blank" href="http://localhost/extensions/qdpm/meteo.php" ><span class="title">Météo des Projets</span></a>
				</li>
				<li>
					<a class="outilDSI"  target="_blank" href="http://localhost/extensions/qdpm/controle.php" ><span class="title">Contrôle des Projets</span></a>
				</li>
			</ul>
        </li>	
			</ul>
