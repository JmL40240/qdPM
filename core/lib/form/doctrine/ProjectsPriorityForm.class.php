 ...
 */
class ProjectsPriorityForm extends BaseProjectsPriorityForm
{
  public function configure()
  {
    ...
    $this->widgetSchema['name']->setAttribute('class','form-control input-mediumrequired');
