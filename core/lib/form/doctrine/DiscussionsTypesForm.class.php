 ...
 */
class DiscussionsTypesForm extends BaseDiscussionsTypesForm
{
  public function configure()
  {
    $this->widgetSchema['extra_fields'] = new sfWidgetFormChoice(array('choices'=>ExtraFields::getFieldsByType('discussions'),'expanded'=>true,'multiple'=>true));
