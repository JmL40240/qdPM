...
/**
 * EventsPriority form base class.
 *
 * @method EventsPriority getObject() Returns the current form's model object
 *
 * @package    sf_sandbox
 * @subpackage form
 ...
 */
abstract class BaseEventsPriorityForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('events_priority[%s]');
