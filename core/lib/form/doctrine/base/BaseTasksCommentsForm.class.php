...
abstract class BaseTasksCommentsForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'tasks_types_id'    => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('TasksTypes'), 'add_empty' => true)),
      'tasks_labels_id'   => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('TasksLabels'), 'add_empty' => true)),
      'togo_hours'        => new sfWidgetFormInputText(),
    ));
    ...
    $this->setValidators(array(
      ...
      'tasks_types_id'    => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('TasksTypes'), 'required' => false)),
      'tasks_labels_id'   => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('TasksLabels'), 'required' => false)),
      'togo_hours'        => new sfValidatorNumber(array('required' => false)),
    ));
