...
/**
 * WikiHistory form base class.
 *
 * @method WikiHistory getObject() Returns the current form's model object
 *
 * @package    sf_sandbox
 * @subpackage form
 ...
 */
abstract class BaseWikiHistoryForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      'id'          => new sfWidgetFormInputHidden(),
      'wiki_id'     => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('Wiki'), 'add_empty' => false)),
    ...
    $this->setValidators(array(
      ...
      'wiki_id'     => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('Wiki'))),
    ...
    $this->widgetSchema->setNameFormat('wiki_history[%s]');
