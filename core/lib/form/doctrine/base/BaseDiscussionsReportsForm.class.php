...
abstract class BaseDiscussionsReportsForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'discussions_priority_id' => new sfWidgetFormTextarea(),
      ...
      'discussions_types_id'    => new sfWidgetFormTextarea(),
      'discussions_groups_id'   => new sfWidgetFormTextarea(),
    ...
    $this->setValidators(array(
      ...
      'discussions_priority_id' => new sfValidatorString(array('required' => false)),
      ...
      'discussions_types_id'    => new sfValidatorString(array('required' => false)),
      'discussions_groups_id'   => new sfValidatorString(array('required' => false)),
