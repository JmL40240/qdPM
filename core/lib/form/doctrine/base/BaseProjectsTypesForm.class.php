...
/**
 * ProjectsTypes form base class.
 *
 * @method ProjectsTypes getObject() Returns the current form's model object
 *
 * @package    sf_sandbox
 * @subpackage form
 ...
 */
abstract class BaseProjectsTypesForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'tasks_columns_list' => new sfWidgetFormTextarea(),
    ...
    $this->setValidators(array(
      ...
      'tasks_columns_list' => new sfValidatorString(array('required' => false)),
    ...
    $this->widgetSchema->setNameFormat('projects_types[%s]');
