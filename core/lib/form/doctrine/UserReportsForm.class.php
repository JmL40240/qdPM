...
class UserReportsForm extends BaseUserReportsForm
{
  public function configure()
  {
    ...
    $this->widgetSchema['has_related_ticket'] = new sfWidgetFormInputCheckbox(array(),array('value'=>1));
    $this->setDefault('has_related_ticket', false);
    
    $this->widgetSchema['has_estimated_time'] = new sfWidgetFormInputCheckbox(array(),array('value'=>1));
    $this->setDefault('has_estimated_time', false);
    
    $this->widgetSchema['overdue_tasks'] = new sfWidgetFormInputCheckbox(array(),array('value'=>1));
    $this->setDefault('overdue_tasks', false);
    
    $this->widgetSchema['days_before_due_date']->setAttributes(array('class'=>'form-control input-xsmall'));
    
    $this->widgetSchema['due_date_from'] = new sfWidgetFormInput(array(),array('class'=>'form-control '));
    $this->widgetSchema['due_date_to'] = new sfWidgetFormInput(array(),array('class'=>'form-control '));
    ...
    $this->widgetSchema['listing_order'] = new sfWidgetFormChoice(array('choices'=>userReports::getListingOrderChoices()),array('class'=>'form-control input-medium'));
    ...
    $days_list = array(t::__('Sunday'),t::__('Monday'),t::__('Tuesday'),t::__('Wednesday'),t::__('Thursday'),t::__('Friday'),t::__('Saturday'));
    $this->widgetSchema['report_reminder'] = new sfWidgetFormChoice(array('choices' => $days_list,'multiple'=>true, 'expanded'=>true));
    
    $this->widgetSchema->setLabels(array('is_mandatory'=>'Mandatory Report','display_on_home'=>'Display on dashboard','listing_order'=>'Order By','users_groups_id'=>'Users Groups','report_reminder'  => 'Send email notification every'));
