...
class ProjectsPhasesForm extends BaseProjectsPhasesForm
{
  ...
  {
    $this->widgetSchema['phases_status_id'] = new sfWidgetFormChoice(array('choices'=>app::getItemsChoicesByTable('PhasesStatus')),array('class'=>'form-control input-medium'));
    ...
    $this->widgetSchema['due_date'] = new sfWidgetFormInput(array(),array('class'=>'form-control','readonly'=>'readonly'));    
