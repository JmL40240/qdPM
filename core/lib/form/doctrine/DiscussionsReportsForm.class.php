 ...
 */
class DiscussionsReportsForm extends BaseDiscussionsReportsForm
{
  public function configure()
  {
    ...
    $this->widgetSchema['listing_order'] = new sfWidgetFormChoice(array('choices'=>DiscussionsReports::getListingOrderChoices()),array('class'=>'form-control input-medium'));
