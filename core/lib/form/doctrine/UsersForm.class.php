...
class UsersForm extends BaseUsersForm
{
  ...
  {        
    ...
    $this->widgetSchema['default_home_page'] = new sfWidgetFormChoice(array('choices' => Users::getDefaultHomePagesList($this->getOption('sf_user'),true)),array('class'=>'form-control input-medium')); 
    ...
    unset($this->widgetSchema['hidden_common_reports']);
    unset($this->validatorSchema['hidden_common_reports']);
    unset($this->widgetSchema['hidden_dashboard_reports']);
    unset($this->validatorSchema['hidden_dashboard_reports']);
    unset($this->widgetSchema['sorted_dashboard_reports']);
    unset($this->validatorSchema['sorted_dashboard_reports']);
    unset($this->widgetSchema['public_scheduler_evens_onmenu']);
    unset($this->validatorSchema['public_scheduler_evens_onmenu']);
    unset($this->widgetSchema['personal_scheduler_evens_onmenu']);
    unset($this->validatorSchema['personal_scheduler_evens_onmenu']);
    unset($this->widgetSchema['public_scheduler_email_evens']);
    unset($this->validatorSchema['public_scheduler_email_evens']);
    unset($this->widgetSchema['public_scheduler_evens_onhome']);
    unset($this->validatorSchema['public_scheduler_evens_onhome']);    
    unset($this->widgetSchema['personal_scheduler_email_evens']);
    unset($this->validatorSchema['personal_scheduler_email_evens']);
    unset($this->widgetSchema['personal_scheduler_evens_onhome']);
    unset($this->validatorSchema['personal_scheduler_evens_onhome']);
