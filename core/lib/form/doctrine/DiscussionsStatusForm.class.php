 ...
 */
class DiscussionsStatusForm extends BaseDiscussionsStatusForm
{
  public function configure()
  {
    ...
    $this->widgetSchema['status_group'] = new sfWidgetFormChoice(array('choices'=>app::getStatusGroupsChoices()),array('class'=>'form-control input-medium'));
