 ...
 */
class EventsTypesForm extends BaseEventsTypesForm
{
  public function configure()
  {
    $this->widgetSchema['extra_fields'] = new sfWidgetFormChoice(array('choices'=>ExtraFields::getFieldsByType('events'),'expanded'=>true,'multiple'=>true));
