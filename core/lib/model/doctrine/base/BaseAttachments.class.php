 ...
 * @method Attachments setDateAdded()  Sets the current record's "date_added" value
 * @method Attachments setUsersId()    Sets the current record's "users_id" value
 * @method Attachments setUsers()      Sets the current record's "Users" value
 * 
 * @package    sf_sandbox
 * @subpackage model
...
abstract class BaseAttachments extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        ...
        $this->hasColumn('date_added', 'integer', 4, array(
             'type' => 'integer',
             'fixed' => 0,
             'unsigned' => false,
             'primary' => false,
