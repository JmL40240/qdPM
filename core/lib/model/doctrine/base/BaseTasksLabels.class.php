 ...
 * @method TasksLabels         setBackgroundColor()  Sets the current record's "background_color" value
 * @method TasksLabels         setTasks()            Sets the current record's "Tasks" collection
 * @method TasksLabels         setTasksComments()    Sets the current record's "TasksComments" collection
 * 
 * @package    sf_sandbox
 * @subpackage model
