...
Doctrine_Manager::getInstance()->bindComponent('TasksTypes', 'doctrine');
 ...
 * @method TasksTypes          setId()               Sets the current record's "id" value
 * @method TasksTypes          setName()             Sets the current record's "name" value
 * @method TasksTypes          setSortOrder()        Sets the current record's "sort_order" value
 * @method TasksTypes          setDefaultValue()     Sets the current record's "default_value" value
 * @method TasksTypes          setActive()           Sets the current record's "active" value
 * @method TasksTypes          setExtraFields()      Sets the current record's "extra_fields" value
 * @method TasksTypes          setBackgroundColor()  Sets the current record's "background_color" value
 * @method TasksTypes          setTasks()            Sets the current record's "Tasks" collection
 * @method TasksTypes          setTasksComments()    Sets the current record's "TasksComments" collection
 * 
 * @package    sf_sandbox
 * @subpackage model
 ...
 */
abstract class BaseTasksTypes extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('tasks_types');
    ...
    public function setUp()
    {
        ...
        $this->hasMany('Tasks', array(
             'local' => 'id',
             'foreign' => 'tasks_type_id'));

        $this->hasMany('TasksComments', array(
             'local' => 'id',
             'foreign' => 'tasks_types_id'));
    }
}