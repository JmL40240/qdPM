...
<head>
  ...
  #message { padding: 10px; margin-bottom: 10px; background-color: #eee; -moz-border-radius: 10px; -webkit-border-radius: 10px; border-radius: 10px; color: red;}
...
<body>
  <center>
  <div id="main">  
  <div><?php echo $_SERVER['HTTP_HOST'] . @$_SERVER['REQUEST_URI'] ?></div>
