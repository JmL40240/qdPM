...
$logger = new sfFileLogger($this->dispatcher, array_merge(array('auto_shutdown' => false), array (
  'level' => 'debug',
  'file' => 'D:\\Apache Data\\core\\log/qdPMExtended_prod.log',
)));
$this->factories['logger']->addLogger($logger);
  ...
  'cache_dir' => 'D:\\Apache Data\\core\\cache\\qdPMExtended\\prod\\i18n',
  'lifetime' => 31556926,
  'prefix' => 'D:\\Apache Data\\core\\apps\\qdPMExtended/i18n',
));
...
'auto_shutdown' => false, 'session_id' => $this->getRequest()->getParameter('qdPMExtendedV3'),
), sfConfig::get('sf_factory_storage_parameters', array (
  'session_name' => 'qdPMExtendedV3',
))));
  ...
  'automatic_cleaning_factor' => 0,
  'cache_dir' => 'D:\\Apache Data\\core\\cache\\qdPMExtended\\prod\\template',
  'lifetime' => 86400,
  'prefix' => 'D:\\Apache Data\\core\\apps\\qdPMExtended/template',
)));
